...
//  KindleMock
//
//  Created by Kevin Molina on 2/14/19.
...
class BookCell: UITableViewCell {
    ...
    var book: Book? {
        didSet {
            ...
            guard let url = URL(string: coverImageUrl) else { return } // unwrap url
            ...
            }.resume() // if you don't call this, you won't hit the external image.
    ...
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "This is the text for the title of the book inside of our cell"
    ...
    private let authorLabel: UILabel = {
        let label = UILabel()
        label.text = "This is the text for the author of the book inside of our cell"
